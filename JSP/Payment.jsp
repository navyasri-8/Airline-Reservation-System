...
<body>
	<%
		...
		if(fareid!=null && doj!=null)
		{
			Fare fare=getFareById(Integer.parseInt(fareid));
	%>
	<h2>Complete Your Payment Here</h2>
	<div class="row">
		<div class="col-75">
			<div class="container">
				<form action="mainServlet" method="post" name="appform">
					
					<input type="hidden" name="type" value="com.voidmain.pojo.Ticket">
					<input type="hidden" name="operation" value="add"> 
					<input type="hidden" name="redirect" value="viewtickets.jsp">
					
					<input type="hidden" name="flightid" value="<%=fare.getFlightid()%>">
					<input type="hidden" name="seatclass" value="<%=fare.getSeatclass()%>">
					<input type="hidden" name="dateofjourney" value="<%=doj%>">
					<input type="hidden" name="userid" value="<%=(String)request.getSession().getAttribute("username")%>">
